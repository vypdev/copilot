...
export declare class LinkedBranchRepository implements LinkedBranchCommandPort {
    ...
    createLinkedBranch: (owner: string, repo: string, baseBranchName: string, newBranchName: string, issueNumber: number, oid: string | undefined, token: string) => Promise<import("../../model/result").Result[]>;
}

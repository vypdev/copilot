...
export declare const COPILOT_COMMAND_NAMES: readonly ["help", "analyze", "plan", "clarify", "estimate", "test-plan", "status", "description", "explain", "diagnose", "review", "findings", "fix", "dismiss", "remember", "recheck", "implement"];

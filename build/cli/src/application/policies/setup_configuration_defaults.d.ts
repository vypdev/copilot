...
export declare const SETUP_AGENT_TASK_FEATURES: Readonly<Record<AgentTask, readonly string[]>>;
export declare function setupAgentTasksForFeatures(configuration: Pick<SetupConfiguration, 'features'>): AgentTask[];

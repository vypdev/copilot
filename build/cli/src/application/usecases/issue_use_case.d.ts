...
export declare class IssueUseCase implements ParamUseCase<Execution, Result[]> {
    ...
    taskId: string;
    constructor(recommendStepsUseCase: ParamUseCase<Execution, Result[]>, answerIssueHelpUseCase: ParamUseCase<Execution, Result[]>, workflowSteps: IssueWorkflowSteps, actorAuthorizationPort?: ActorAuthorizationPort | undefined);

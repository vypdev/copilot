export interface GithubReleaseClient {
    rest: {
        ...
        repos: {
            getReleaseByTag(parameters: Record<string, unknown>): Promise<{
                data: {
                    name?: string | null;
                    body?: string | null;
                    draft: boolean;
            ...
            listReleases(parameters: Record<string, unknown>): Promise<{
                data: Array<{
                    id: number;
                    tag_name: string;
                }>;
            ...
            createRelease(parameters: Record<string, unknown>): Promise<{
                data: {
                    id: number;
                    html_url: string;
                };

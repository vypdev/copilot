...
export interface GithubIssueContentClient {
    ...
    rest: {
        issues: {
            ...
            listComments(parameters: Record<string, unknown>): Promise<{
                data: GithubIssueComment[];
            }>;
        };
    };
...
export interface GithubIssueLabelsClient {
    rest: {
        issues: {
            listLabelsOnIssue(parameters: Record<string, unknown>): Promise<{
                data: Array<{
                    name: string;
                }>;
            }>;
...
export interface GithubIssueAssignmentClient {
    rest: {
        issues: {
            ...
            addAssignees(parameters: Record<string, unknown>): Promise<{
                data: {
                    assignees?: Array<{
                        login: string;
                    }> | null;

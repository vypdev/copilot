 ...
 */
export declare function enforceAgentExecutionPolicy(provider: AgentProvider | undefined, capability: AgentCapability | undefined, args: readonly string[], managedOutputSchemaPath?: string): string[];

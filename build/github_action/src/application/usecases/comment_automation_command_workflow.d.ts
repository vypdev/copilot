...
export declare function runExplicitCommentCommand(param: Execution, options: CommentAutomationOptions, command: ParsedCopilotCommand, actorAuthorizationPort: ActorAuthorizationPort, authenticatedUserPort: AuthenticatedUserPort): Promise<Result[] | undefined>;

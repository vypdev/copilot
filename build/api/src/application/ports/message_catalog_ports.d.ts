...
import type { CatalogMessage, MessageCatalogDefinition, ResolvedMessageCatalog, CatalogResolutionObservation } from '../../domain/message_catalog';
...
export interface MessageCatalogResolutionPort {
    resolve<Id extends string>(request: MessageCatalogResolutionRequest<Id>): Promise<ResolvedMessageCatalog<Id>>;

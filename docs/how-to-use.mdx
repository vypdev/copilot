...
2. Ensure every Copilot step uses a stable Action reference such as
   `vypdev/copilot@ae6bdef3be7d896bb2e390d169f103d384ae83a3 # v3` and passes a write-capable `token` where required.
...
versions, and non-interactive help commands without making a paid model request. Runtime

...
<CardGroup cols={2}>
  ...
  <Card title="Product specifications" icon="diagram-project" href="/development/specifications">
    Find the SDD that owns a capability and its implementation evidence.
  </Card>

...
**Bugbot** (potential problems) runs on PR review events, on **push** to an issue-linked branch, or on demand; findings appear as **review comments** on the PR and, when an issue is linked, as **comments on that issue**. For full details, see [Bugbot](/bugbot).

...
and the `COPILOT_ISSUE_WORKFLOW_PROFILE` Repository Variable. Empty input keeps
legacy all-workflow behavior for manually wired repositories. A configured
profile is fail-closed: unknown, disabled, conflicting, or incomplete issue

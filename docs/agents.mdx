...
<CardGroup cols={2}>
  <Card title="Agent contract" icon="file-lines" href="/agent-execution-contract">
    Understand the runtime/model tuple and effective configuration.
  </Card>
  <Card title="Runtime selection" icon="microchip" href="/runtime-selection">
    Compare OpenCode, Codex, and Cursor execution modes.
  </Card>
  <Card title="Model selection" icon="gear" href="/model-selection">

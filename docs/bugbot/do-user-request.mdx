...
Intent is inferred by the configured analysis role from the comment text and the list of unresolved findings; you don’t need to tag or label the comment.

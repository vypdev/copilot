...
generic roll-up. The Job Summary keeps compact result states and safe error
recovery evidence; internal step narration and arbitrary error text remain in logs.

...
cannot start a write-capable descendant. The setup templates use `vypdev/copilot@v2`
for this gate and therefore require a published v2 bundle that supports
`queue-gate-only`.

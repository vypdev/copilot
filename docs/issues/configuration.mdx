...
- `ai-pull-request-description`: Enable AI-powered PR descriptions (default: `true`)
...
- `merge-timeout`: Timeout for deprecated `legacy-wait` in seconds (default:
  `600`; `0` disables its artificial timeout). Other reconciliation PR modes
  ignore it and let GitHub own pending checks and merge protection.

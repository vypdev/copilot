...
<CardGroup cols={3}>
  ...
  <Card title="Configuration" icon="gear" href="/configuration">
    All inputs: branches, labels, projects, locale, agents, and more.
  </Card>
  <Card title="Release orchestration" icon="rocket" href="/issues/deployment-orchestration">
    Production-first release and hotfix promotion, publication, reconciliation, and recovery.
  </Card>
  <Card title="Single actions" icon="play" href="/single-actions">
    Run supported on-demand actions and understand internal deployment continuations.
  </Card>
  <Card title="Bugbot" icon="bug" href="/bugbot">
    How to use and how it works: detection, autofix, and do-user-request.
  </Card>
  <Card title="Troubleshooting" icon="wrench" href="/security-operations/operations/troubleshooting">
...
### Performance
- Fast execution
- **Workflow coordination** — Durable mutations queue without discarding intermediate events. Commit and Pull Request use separate branch-scoped lanes, and an open PR makes its synchronization event the sole Bugbot owner for that head (see [Features → Workflow concurrency](/features#workflow-concurrency-and-sequential-execution)).

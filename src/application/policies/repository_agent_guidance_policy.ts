...
export interface RepositoryAgentProfile {
  ...
  readonly branches: {
    ...
    readonly launcher: { readonly mode: 'always' | 'label'; readonly label: string };
...
export function buildRepositoryAgentProfile(configuration: Readonly<SetupConfiguration>): RepositoryAgentProfile {
  ...
  return Object.freeze({
    ...
    generator: Object.freeze({ name: '@vypdev/copilot' as const, contractVersion: 1 as const }),
    ...
    branches: Object.freeze({
      ...
      launcher: Object.freeze({
        mode: configuration.repository.branchManagementAlways ? 'always' as const : 'label' as const,

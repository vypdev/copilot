export interface GithubCredentialHealthClient {
    rest: {
        actions: {
            ...
            listWorkflowRuns(parameters: Record<string, unknown>): Promise<{ data: { workflow_runs: GithubWorkflowRun[] } }>;
            getWorkflowRun(parameters: Record<string, unknown>): Promise<{ data: GithubWorkflowRun }>;
            listJobsForWorkflowRun(parameters: Record<string, unknown>): Promise<{ data: { jobs: GithubWorkflowJob[] } }>;
    ...
    repos: {
        ...
        createOrUpdateFileContents(parameters: Record<string, unknown>): Promise<{ data?: { content?: { sha?: string } } }>;
